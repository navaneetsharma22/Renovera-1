...
export function ClientTestimonial({ project, className }) {
    ...
    <section ref={sectionRef} className={cn("py-24 md:py-32 bg-white", className)}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1000px]">
        ...
        <div ref={contentRef} className="flex flex-col items-center text-center">
          ...
          <h3 className="text-3xl md:text-5xl font-serif italic text-[#09090B] leading-relaxed mb-12 relative">
            <span className="text-6xl md:text-8xl text-[#E4E4E7] absolute -top-8 -left-8 md:-top-12 md:-left-12 -z-10 select-none">"</span>
            {project.testimonial.quote}
            <span className="text-6xl md:text-8xl text-[#E4E4E7] absolute -bottom-16 -right-4 md:-bottom-20 md:-right-8 -z-10 select-none">"</span>
          </h3>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-[#52525B]">
                {project.testimonial.project} — {project.testimonial.location}
              </span>
            </div>
          </div>
