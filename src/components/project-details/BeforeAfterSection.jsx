...
export function BeforeAfterSection({ project, className }) {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24 mb-16 md:mb-24">
          <div className="lg:w-1/2">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              {project.beforeAfter.summary}
            </p>
          </div>
          <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-3 gap-6">
            {project.beforeAfter.metrics.map((metric, idx) => (
              <div key={idx} className="flex flex-col border-l border-white/20 pl-6">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#C5A059] mb-2">{metric.label}</span>
