...
export function ProcessTimeline({ project, className }) {
        ...
        <div className="relative border-l border-[#E4E4E7] ml-4 md:ml-0 md:border-none">
          ...
          {project.process.map((step, idx) => {
            ...
            return (
              ...
              >
                <div className="absolute left-[-5px] md:left-1/2 top-2 md:top-1/2 w-[11px] h-[11px] bg-[#09090B] rounded-full transform md:-translate-x-1/2 md:-translate-y-1/2 ring-4 ring-white" />
