...
export function ConsultationCTA({ service, className }) {
  ...
  return (
    <section ref={sectionRef} className={cn("py-32 md:py-48 bg-[#09090B] relative overflow-hidden", className)}>
      ...
      <div className="absolute bottom-0 right-1/2 translate-x-1/2 w-[800px] h-[800px] bg-[#C5A059]/5 rounded-full blur-[100px] pointer-events-none" />
