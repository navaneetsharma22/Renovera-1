...
export function ServicesCTA({ className }) {
  ...
  return (
    <section ref={sectionRef} className={cn("py-32 md:py-48 bg-[#09090B] relative overflow-hidden", className)}>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#C5A059]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={contentRef} className="max-w-[800px] mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            ...
            >
              {servicesPageData.cta.primaryCTA}
            </Link>
            ...
            >
              {servicesPageData.cta.secondaryCTA}
            </a>
          </div>
