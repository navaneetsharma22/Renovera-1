...
export function ServicesHero({ className }) {
  ...
  return (
    <section ref={sectionRef} className={cn("relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-24", className)}>
      <div className="absolute inset-0 z-0">
        <Image
          ref={bgRef}
          src={servicesPageData.hero.image}
          alt="Renovera Services"
          fill
          priority
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <div ref={contentRef} className="max-w-[800px] mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            ...
            >
              {servicesPageData.hero.primaryCTA}
            </Link>
            <Link 
              href="/projects"
            ...
            >
              {servicesPageData.hero.secondaryCTA}
            </Link>
          </div>
        </div>
      </div>
